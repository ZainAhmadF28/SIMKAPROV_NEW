...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($username === '' || $email === '' || $password === '' || $confirm_password === '' || ($role !== 'admin' && $role !== 'user')) {
        ...
        if ($resCheck->num_rows > 0) {
            ...
            $stmtInsert->bind_param("ssss", $username, $email, $hashed_password, $role);

            if ($stmtInsert->execute()) {
                $_SESSION['success'] = "User '" . htmlspecialchars($username) . "' berhasil ditambahkan.";
...
<head>
    ...
    <title>Tambah Pengguna Baru - SIMKAPROV</title>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="form-card" data-aos="fade-up">
                ...
                <?php endif; ?>
                <?php if ($success): // Seharusnya tidak akan tampil karena ada redirect, tapi sebagai fallback ?>
