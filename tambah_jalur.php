...
// Proses untuk menambah data jalur
if (isset($_POST['add'])) {
    ...
    $stmt_add = $conn->prepare("INSERT INTO jalur_kereta_admin (nama_jalan, latitude, longitude) VALUES (?, ?, ?)");
    $stmt_add->bind_param("sss", $nama, $latitude, $longitude);
    
    if ($stmt_add->execute()) {
        header("Location: semua_jalur.php"); // Redirect ke halaman daftar jalur setelah berhasil
        exit();
    } else {
...
<head>
    ...
    <title>Tambah Jalur Kereta - SIMKAPROV</title>
    ...
    <style>
        ...
        /* [PERUBAHAN] Navbar diubah menjadi glassmorphism */
        .navbar {
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="form-card" data-aos="fade-up">
                <h1 class="text-center">Tambah Data Jalur Kereta Baru</h1>
                ...
                <form method="POST" action="">
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4">
                        ...
                        <button type="submit" name="add" class="btn btn-submit">
                            <i class="bi bi-plus-circle-fill me-2"></i>Tambah Jalur
                        </button>
                    </div>
                </form>
