...
// Tangani pesan error/success dari session (misal dari delete_user.php)
...
<title>Kelola Pengguna - SIMKAPROV</title>
                    ...
                    <?php while($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="delete_user.php?id=<?= $row['id'] ?>" onclick="return confirm('Yakin ingin menghapus user <?= htmlspecialchars($row['username']) ?>?');" class="btn btn-delete btn-sm btn-action">Hapus</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                <?php else: ?>
